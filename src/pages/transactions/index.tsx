...
export function TransactionListPage(props: TransactionListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'transaction_type', header: 'Transaction Type', accessorKey: 'transaction_type' },
    ...
    hasAccess('account', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/accounts/view/${record.account?.id}`}>
